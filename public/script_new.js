...
const elements = {
    ...
    totalReposDetail: document.getElementById('totalReposDetail'),
    totalImagesDetail: document.getElementById('totalImagesDetail'),
    totalSizeDetail: document.getElementById('totalSizeDetail'),
...
function displayStatistics() {
    // Update quick stats (in home page)
    ...
    // Update detailed stats (in stats page)
    if (elements.totalReposDetail) {
        elements.totalReposDetail.textContent = statistics.totalRepositories || 0;
    }
    if (elements.totalImagesDetail) {
        elements.totalImagesDetail.textContent = statistics.totalImages || 0;
    }
    if (elements.totalSizeDetail) {
        elements.totalSizeDetail.textContent = formatBytes(statistics.totalSize || 0);
    }
    
    // Update repository stats list
    if (elements.repoStatsList) {
